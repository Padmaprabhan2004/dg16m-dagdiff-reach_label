...
class ConvGraspClassifier(GraspDiffusionFields):
    def __init__(self, vision_encoder, geometry_encoder, points, vision_decoder, feature_encoder, fc_classifier):
        super().__init__(vision_encoder, geometry_encoder, points, feature_encoder, None)
        self.vision_decoder = vision_decoder
        self.classifier = fc_classifier
        self.z = None
